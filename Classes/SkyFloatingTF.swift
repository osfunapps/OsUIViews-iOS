 ...
 */
@IBDesignable
open class SkyFloatingTF: UITextField { // swiftlint:disable:this type_body_length
    
    // finals
    public static let PADDING_HORIZONTAL: CGFloat = 10
    public static let PADDING_START: CGFloat = 10
    public static let PADDING_PLACE_HOLDER_TOP: CGFloat = -6
    public static let PADDING_EDITING_TOP: CGFloat = 10
...
//        }
    ...
    */
    ...
    fileprivate func addEditingChangedObserver() {
        self.addTarget(self, action: #selector(SkyFloatingTF.editingChanged), for: .editingChanged)
    }
    ...
    */
    ...
    // osApps 1
    // titlerect title rect
    open func titleLabelRectForBounds(_ bounds: CGRect, editing: Bool) -> CGRect {
//        if editing {
            return CGRect(x: SkyFloatingTF.PADDING_START,
                          y: SkyFloatingTF.PADDING_HORIZONTAL,
                          width: bounds.size.width,
                          height: titleHeight())
//        }
//        return CGRect(x: SkyFloatingTF.PADDING_SIZE,
//                      y: SkyFloatingTF.PADDING_SIZE,
//                      width: bounds.size.width,
//                      height: titleHeight())
    }
    ...
    */
    ...
    // osApps 2 not edited, done
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        let superRect = super.textRect(forBounds: bounds)
        let titleHeight = self.titleHeight()

        let rect = CGRect(
            x: superRect.origin.x + SkyFloatingTF.PADDING_START,
            y: SkyFloatingTF.PADDING_HORIZONTAL +
            titleHeight +
            SkyFloatingTF.PADDING_EDITING_TOP,
            width: superRect.size.width,
            height: superRect.size.height -
                SkyFloatingTF.PADDING_HORIZONTAL -
                titleHeight -
                SkyFloatingTF.PADDING_EDITING_TOP -
                SkyFloatingTF.PADDING_HORIZONTAL -
                selectedLineHeight
     ...
     */
    // osApps 4 placeholder place holder
    override open func placeholderRect(forBounds bounds: CGRect) -> CGRect {
        let titleHeight = titleHeight()
        let rect = CGRect(
            x: SkyFloatingTF.PADDING_START,
            y: SkyFloatingTF.PADDING_HORIZONTAL +
                titleHeight +
                SkyFloatingTF.PADDING_EDITING_TOP,
//            y: titleHeight(),
            ...
            height:
                ...
                SkyFloatingTF.PADDING_HORIZONTAL -
                titleHeight -
                SkyFloatingTF.PADDING_PLACE_HOLDER_TOP -
                SkyFloatingTF.PADDING_HORIZONTAL -
                selectedLineHeight
        )
        return rect
    ...
    */
     ...
     */
    // osApps 5 calculate total height
    // + padding to top + padding to bottom +
    override open var intrinsicContentSize: CGSize {
        return CGSize(width: bounds.size.width,
                      height: SkyFloatingTF.PADDING_HORIZONTAL +
                        titleHeight() +
                        SkyFloatingTF.PADDING_EDITING_TOP +
                        textHeight() +
                        SkyFloatingTF.PADDING_HORIZONTAL
